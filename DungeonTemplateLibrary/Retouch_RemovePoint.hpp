...
namespace dtl::retouch {
	...
	using RemovePointU8 = dtl::retouch::RemovePoint<std::uint_fast8_t>;
	using RemovePointU16 = dtl::retouch::RemovePoint<std::uint_fast16_t>;
	using RemovePointU32 = dtl::retouch::RemovePoint<std::uint_fast32_t>;
	using RemovePointU64 = dtl::retouch::RemovePoint<std::uint_fast64_t>;
	using RemovePointI8 = dtl::retouch::RemovePoint<std::int_fast8_t>;
	using RemovePointI16 = dtl::retouch::RemovePoint<std::int_fast16_t>;
	using RemovePointI32 = dtl::retouch::RemovePoint<std::int_fast32_t>;
	using RemovePointI64 = dtl::retouch::RemovePoint<std::int_fast64_t>;
}
