...
int main() {
	...
	dtl::fileWrite_bmp(big_dungeon_stl_matrix, "Save/test_rl.bmp");
	...
	dtl::fileWrite_md(big_dungeon_stl_matrix, "Save/test.md");
	dtl::fileWrite_0_9(big_dungeon_stl_matrix, "Save/test09.dat");
	...
	dtl::fileWrite_md(ds_dungeon_stl_matrix, "Save/test_ds.md");
