		...
		namespace stl {
			...
			constexpr void createChess(Matrix_& matrix_) noexcept {
				...
				for (std::size_t i{}; i < matrix_[1].size(); ++i)
					matrix_[1][i] = dtl::generator::data::chess_pawn2;
				for (std::size_t i{}; i < matrix_[matrix_.size() - 2].size(); ++i)
					matrix_[matrix_.size() - 2][i] = dtl::generator::data::chess_pawn1;

				if (matrix_[0].size() < 4) return;
				matrix_[0][0] = dtl::generator::data::chess_rook2;
				matrix_[0][matrix_[0].size() - 1] = dtl::generator::data::chess_rook2;
				matrix_[0][1] = dtl::generator::data::chess_knight2;
				matrix_[0][matrix_[0].size() - 2] = dtl::generator::data::chess_knight2;
				matrix_[0][2] = dtl::generator::data::chess_bishop2;
				matrix_[0][matrix_[0].size() - 3] = dtl::generator::data::chess_bishop2;
				matrix_[0][3] = dtl::generator::data::chess_queen2;
				matrix_[0][matrix_[0].size() - 4] = dtl::generator::data::chess_king2;
				if (matrix_[matrix_.size() - 1].size() < 4) return;
				matrix_[matrix_.size() - 1][0] = dtl::generator::data::chess_rook1;
				matrix_[matrix_.size() - 1][matrix_[matrix_.size() - 1].size() - 1] = dtl::generator::data::chess_rook1;
				matrix_[matrix_.size() - 1][1] = dtl::generator::data::chess_knight1;
				matrix_[matrix_.size() - 1][matrix_[matrix_.size() - 1].size() - 2] = dtl::generator::data::chess_knight1;
				matrix_[matrix_.size() - 1][2] = dtl::generator::data::chess_bishop1;
				matrix_[matrix_.size() - 1][matrix_[matrix_.size() - 1].size() - 3] = dtl::generator::data::chess_bishop1;
				matrix_[matrix_.size() - 1][3] = dtl::generator::data::chess_queen1;
				matrix_[matrix_.size() - 1][matrix_[matrix_.size() - 1].size() - 4] = dtl::generator::data::chess_king1;
			}
			template<typename Matrix_Int_>
			class Chess {
			public:
				...
				constexpr void create(Matrix_& matrix_) noexcept {
					dtl::generator::stl::createChess(matrix_);
				}
			};
		}
		...
		namespace normal {
			...
			constexpr void createChess(Matrix_& matrix_, const std::size_t  x_, const std::size_t y_) noexcept {
				...
				for (std::size_t col{}; col < x_; ++col)
					matrix_[1][col] = dtl::generator::data::chess_pawn2;
				for (std::size_t col{}; col < x_; ++col)
					matrix_[y_ - 2][col] = dtl::generator::data::chess_pawn1;

				if (x_ < 4) return;
				matrix_[0][0] = dtl::generator::data::chess_rook2;
				matrix_[0][x_ - 1] = dtl::generator::data::chess_rook2;
				matrix_[0][1] = dtl::generator::data::chess_knight2;
				matrix_[0][x_ - 2] = dtl::generator::data::chess_knight2;
				matrix_[0][2] = dtl::generator::data::chess_bishop2;
				matrix_[0][x_ - 3] = dtl::generator::data::chess_bishop2;
				matrix_[0][3] = dtl::generator::data::chess_queen2;
				matrix_[0][x_ - 4] = dtl::generator::data::chess_king2;
				matrix_[y_ - 1][0] = dtl::generator::data::chess_rook1;
				matrix_[y_ - 1][x_ - 1] = dtl::generator::data::chess_rook1;
				matrix_[y_ - 1][1] = dtl::generator::data::chess_knight1;
				matrix_[y_ - 1][x_ - 2] = dtl::generator::data::chess_knight1;
				matrix_[y_ - 1][2] = dtl::generator::data::chess_bishop1;
				matrix_[y_ - 1][x_ - 3] = dtl::generator::data::chess_bishop1;
				matrix_[y_ - 1][3] = dtl::generator::data::chess_queen1;
				matrix_[y_ - 1][x_ - 4] = dtl::generator::data::chess_king1;
			}
			template<typename Matrix_Int_>
			class Chess {
			public:
				...
				constexpr void create(Matrix_& matrix_, const std::size_t x_, const std::size_t y_) noexcept {
					dtl::generator::normal::createChess(matrix_, x_, y_);
				}
			};
		}
