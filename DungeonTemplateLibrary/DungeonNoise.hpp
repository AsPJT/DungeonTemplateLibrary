...
namespace dtl {
	namespace tile {
		...
		template<typename Matrix_Int_>
		constexpr Matrix_Int_ getWolfAutoTileType(const Matrix_Int_ center_, const Matrix_Int_ next1_, const Matrix_Int_ next2_, const Matrix_Int_ next3_) noexcept {
		...
		//Wolfオートタイル形式の配列値を返す
		constexpr std::size_t getWolfAutoTileID(const std::size_t type_, const std::size_t dir_, const std::size_t anime_num_, const std::size_t anime_max_) noexcept {
			return anime_num_ * 2 + type_ * anime_max_ * 4 + ((dir_ <= tile_upper_right) ? dir_ : dir_ + anime_max_ * 2 - 2);
		}

		//Wolfオートタイル形式の左上の地形タイプを返す
		template<typename Matrix_>
		constexpr auto getWolfAutoTileTypeUpperLeft(const Matrix_& matrix_, const std::size_t x_, const std::size_t y_, const std::size_t min_x_, const std::size_t min_y_) noexcept {
		...
		template<typename Matrix_>
		constexpr auto getWolfAutoTileTypeUpperRight(const Matrix_& matrix_, const std::size_t x_, const std::size_t y_, const std::size_t max_x_, const std::size_t min_y_) noexcept {
		...
		template<typename Matrix_>
		constexpr std::size_t getWolfAutoTileID_UpperLeft(const Matrix_& matrix_, const std::size_t x_, const std::size_t y_, const std::size_t min_x_, const std::size_t min_y_, const std::size_t anime_num_, const std::size_t anime_max_) noexcept {
		...
		template<typename Matrix_>
		constexpr std::size_t getWolfAutoTileID_UpperRight(const Matrix_& matrix_, const std::size_t x_, const std::size_t y_, const std::size_t max_x_, const std::size_t min_y_, const std::size_t anime_num_, const std::size_t anime_max_) noexcept {
		...
		template<typename Matrix_>
		constexpr std::size_t getWolfAutoTileID_LowerLeft(const Matrix_& matrix_, const std::size_t x_, const std::size_t y_, const std::size_t min_x_, const std::size_t max_y_, const std::size_t anime_num_, const std::size_t anime_max_) noexcept {
		...
		template<typename Matrix_>
		constexpr std::size_t getWolfAutoTileID_LowerRight(const Matrix_& matrix_, const std::size_t x_, const std::size_t y_, const std::size_t max_x_, const std::size_t max_y_, const std::size_t anime_num_, const std::size_t anime_max_) noexcept {
		...
		constexpr auto getWolfAutoTileArrayUpperLeft(const Matrix_& matrix_, const TileArray_& tile_array_, const std::size_t x_, const std::size_t y_, const std::size_t min_x_, const std::size_t min_y_, const std::size_t anime_num_, const std::size_t anime_max_) noexcept {
			return tile_array_[getWolfAutoTileID_UpperLeft(matrix_, x_, y_, min_x_, min_y_, anime_num_, anime_max_)];
		}
		//Wolfオートタイル形式の右上の配列値を返す
		template<typename TileArray_, typename Matrix_>
		constexpr auto getWolfAutoTileArrayUpperRight(const Matrix_& matrix_, const TileArray_& tile_array_, const std::size_t x_, const std::size_t y_, const std::size_t max_x_, const std::size_t min_y_, const std::size_t anime_num_, const std::size_t anime_max_) noexcept {
			return tile_array_[getWolfAutoTileID_UpperRight(matrix_, x_, y_, max_x_, min_y_, anime_num_, anime_max_)];
		}
		//Wolfオートタイル形式の左下の配列値を返す
		template<typename TileArray_, typename Matrix_>
		constexpr auto getWolfAutoTileArrayLowerLeft(const Matrix_& matrix_, const TileArray_& tile_array_, const std::size_t x_, const std::size_t y_, const std::size_t min_x_, const std::size_t max_y_, const std::size_t anime_num_, const std::size_t anime_max_) noexcept {
			return tile_array_[getWolfAutoTileID_LowerLeft(matrix_, x_, y_, min_x_, max_y_, anime_num_, anime_max_)];
		}
		//Wolfオートタイル形式の右下の配列値を返す
		template<typename TileArray_, typename Matrix_>
		constexpr auto getWolfAutoTileArrayLowerRight(const Matrix_& matrix_, const TileArray_& tile_array_, const std::size_t x_, const std::size_t y_, const std::size_t max_x_, const std::size_t max_y_, const std::size_t anime_num_, const std::size_t anime_max_) noexcept {
