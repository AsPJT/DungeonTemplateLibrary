...
namespace dtl {
	inline namespace retouch { //"dtl::retouch"名前空間に属する
		...
		class RemovePoint : public ::dtl::range::RectBase<RemovePoint<Matrix_Var_>>,
		                    public ::dtl::utility::DrawJagged<RemovePoint<Matrix_Var_>, Matrix_Var_> {
		private:
			...
			using ShapeBase_t = ::dtl::range::RectBase<RemovePoint>;
			using DrawBase_t = ::dtl::utility::DrawJagged<RemovePoint, Matrix_Var_>;
