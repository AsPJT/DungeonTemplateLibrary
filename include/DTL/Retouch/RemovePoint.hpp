...
namespace dtl {
	inline namespace retouch { //"dtl::retouch"名前空間に属する
		...
		class RemovePoint : public ::dtl::range::RectBase<RemovePoint<Matrix_Int_>>,
		                    public ::dtl::utility::DrawJagged<RemovePoint<Matrix_Int_>, Matrix_Int_> {
		private:
			...
			using DrawBase_t = ::dtl::utility::DrawJagged<RemovePoint, Matrix_Int_>;
