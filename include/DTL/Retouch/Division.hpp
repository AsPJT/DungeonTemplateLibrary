...
#######################################################################################*/
		...
		class Division : public ::dtl::range::RectBaseWithValue<Division<Matrix_Var_>, Matrix_Var_>,
			public ::dtl::utility::DrawJagged<Division<Matrix_Var_>, Matrix_Var_> {
		private:
			...
			using ShapeBase_t = ::dtl::range::RectBaseWithValue<Division, Matrix_Var_>;
			using DrawBase_t = ::dtl::utility::DrawJagged<Division, Matrix_Var_>;
