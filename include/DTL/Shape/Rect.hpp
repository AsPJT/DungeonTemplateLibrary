...
namespace dtl {
	inline namespace shape {
		...
		class Rect : public ::dtl::utility::RectBaseWithValue< ::dtl::shape::Rect<Matrix_Int_>, Matrix_Int_> {
		private:
			...
			using ShapeBase_t = ::dtl::utility::RectBaseWithValue< ::dtl::shape::Rect<Matrix_Int_>, Matrix_Int_>;
