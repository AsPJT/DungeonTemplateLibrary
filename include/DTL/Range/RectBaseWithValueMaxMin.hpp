...
#######################################################################################*/
#ifndef INCLUDED_DUNGEON_TEMPLATE_LIBRARY_DTL_RANGE_RECT_BASE_WITH_MAX_MIN_VALUE_HPP
#define INCLUDED_DUNGEON_TEMPLATE_LIBRARY_DTL_RANGE_RECT_BASE_WITH_MAX_MIN_VALUE_HPP
...
namespace dtl {
	inline namespace range { //"dtl::range"名前空間に属する
		...
		template<typename Derived_, typename Matrix_Var_, Matrix_Var_ matrix_value_ = Matrix_Var_{}
			, Matrix_Var_ default_max_value_ = Matrix_Var_{}, Matrix_Var_ default_min_value_ = Matrix_Var_{} >
		...
		protected:
			...
			Matrix_Var_ max_value{ default_max_value_ };
...
#######################################################################################*/
			...
			constexpr explicit RectBaseWithValueMaxMin(const Matrix_Var_& draw_value_) noexcept
				:draw_value(draw_value_) {}
			constexpr RectBaseWithValueMaxMin(const ::dtl::base::MatrixRange& matrix_range_, const Matrix_Var_& draw_value_) noexcept
				:RectBase_t(matrix_range_),
				draw_value(draw_value_) {}
			constexpr RectBaseWithValueMaxMin(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_, const Matrix_Var_& draw_value_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_),
				draw_value(draw_value_) {}

			constexpr explicit RectBaseWithValueMaxMin(const Matrix_Var_& draw_value_, const Matrix_Var_& max_value_) noexcept
				:draw_value(draw_value_), max_value(max_value_) {}
			constexpr RectBaseWithValueMaxMin(const ::dtl::base::MatrixRange& matrix_range_, const Matrix_Var_& draw_value_, const Matrix_Var_& max_value_) noexcept
				:RectBase_t(matrix_range_),
				draw_value(draw_value_), max_value(max_value_) {}
			constexpr RectBaseWithValueMaxMin(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_, const Matrix_Var_& draw_value_, const Matrix_Var_& max_value_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_),
				draw_value(draw_value_), max_value(max_value_) {}

			constexpr explicit RectBaseWithValueMaxMin(const Matrix_Var_& draw_value_, const Matrix_Var_& max_value_, const Matrix_Var_& min_value_) noexcept
				:draw_value(draw_value_), max_value(max_value_), min_value(min_value_) {}
			constexpr RectBaseWithValueMaxMin(const ::dtl::base::MatrixRange& matrix_range_, const Matrix_Var_& draw_value_, const Matrix_Var_& max_value_, const Matrix_Var_& min_value_) noexcept
				:RectBase_t(matrix_range_),
				draw_value(draw_value_), max_value(max_value_), min_value(min_value_) {}
			constexpr RectBaseWithValueMaxMin(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_, const Matrix_Var_& draw_value_, const Matrix_Var_& max_value_, const Matrix_Var_& min_value_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_),
				draw_value(draw_value_), max_value(max_value_), min_value(min_value_) {}
		};
	}
