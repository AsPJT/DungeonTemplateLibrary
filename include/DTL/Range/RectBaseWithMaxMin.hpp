...
#######################################################################################*/
#ifndef INCLUDED_DUNGEON_TEMPLATE_LIBRARY_DTL_RANGE_RECT_BASE_WITH_MAX_MIN_HPP
#define INCLUDED_DUNGEON_TEMPLATE_LIBRARY_DTL_RANGE_RECT_BASE_WITH_MAX_MIN_HPP
...
namespace dtl {
	inline namespace range { //"dtl::range"名前空間に属する
		...
		class RectBaseWithMaxMin : public ::dtl::range::BasicRect<Derived_> {
		private:
...
#######################################################################################*/
			...
			RectBaseWithMaxMin() = default;
			constexpr explicit RectBaseWithMaxMin(const ::dtl::base::MatrixRange& matrix_range_) noexcept
				:RectBase_t(matrix_range_) {}
			constexpr RectBaseWithMaxMin(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_) {}

			constexpr explicit RectBaseWithMaxMin(const Matrix_Var_& max_value_) noexcept
				:max_value(max_value_) {}
			constexpr RectBaseWithMaxMin(const ::dtl::base::MatrixRange& matrix_range_, const Matrix_Var_& max_value_) noexcept
				:RectBase_t(matrix_range_),
				max_value(max_value_) {}
			constexpr RectBaseWithMaxMin(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_, const Matrix_Var_& max_value_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_),
				max_value(max_value_) {}

			constexpr explicit RectBaseWithMaxMin(const Matrix_Var_& max_value_, const Matrix_Var_& min_value_) noexcept
				:max_value(max_value_), min_value(min_value_) {}
			constexpr RectBaseWithMaxMin(const ::dtl::base::MatrixRange& matrix_range_, const Matrix_Var_& max_value_, const Matrix_Var_& min_value_) noexcept
				:RectBase_t(matrix_range_),
				max_value(max_value_), min_value(min_value_) {}
			constexpr RectBaseWithMaxMin(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_, const Matrix_Var_& max_value_, const Matrix_Var_& min_value_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_),
				max_value(max_value_), min_value(min_value_) {}
		};
	}
