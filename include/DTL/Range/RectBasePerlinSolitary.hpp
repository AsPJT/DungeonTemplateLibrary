...
#######################################################################################*/
#ifndef INCLUDED_DUNGEON_TEMPLATE_LIBRARY_DTL_RANGE_RECT_BASE_WITH_PERLIN_SOLITARY_HPP
#define INCLUDED_DUNGEON_TEMPLATE_LIBRARY_DTL_RANGE_RECT_BASE_WITH_PERLIN_SOLITARY_HPP
...
namespace dtl {
	inline namespace range { //"dtl::range"名前空間に属する
		...
		class RectBasePerlinSolitary : public ::dtl::range::BasicRect<Derived_> {
		private:
		...
		public:
			...
			DTL_VERSIONING_CPP17_NODISCARD
				constexpr double getTruncatedProportion() const noexcept {
				return this->truncated_proportion;
			}
			DTL_VERSIONING_CPP17_NODISCARD
				constexpr double getMountainProportion() const noexcept {
				return this->mountain_proportion;
			}
			DTL_VERSIONING_CPP17_NODISCARD
...
#######################################################################################*/
			DTL_VERSIONING_CPP14_CONSTEXPR
				...
				this->frequency = 0.0;
				this->truncated_proportion = 0.0;
				this->mountain_proportion = 0.0;
				this->octaves = 0;
			...
			DTL_VERSIONING_CPP14_CONSTEXPR
				Derived_& clearTruncatedProportion() noexcept {
				this->truncated_proportion = 0.0;
				return static_cast<Derived_&>(*this);
			}
			DTL_VERSIONING_CPP14_CONSTEXPR
				Derived_& clearMountainProportion() noexcept {
				this->mountain_proportion = 0.0;
				return static_cast<Derived_&>(*this);
			}
			DTL_VERSIONING_CPP14_CONSTEXPR
			...
			DTL_VERSIONING_CPP14_CONSTEXPR
				Derived_& setTruncatedProportion(const double truncated_proportion_) noexcept {
				this->truncated_proportion = truncated_proportion_;
				return static_cast<Derived_&>(*this);
			}
			DTL_VERSIONING_CPP14_CONSTEXPR
				Derived_& setMountainProportion(const double mountain_proportion_) noexcept {
				this->mountain_proportion = mountain_proportion_;
				return static_cast<Derived_&>(*this);
			}
			DTL_VERSIONING_CPP14_CONSTEXPR
			...
			RectBasePerlinSolitary() = default;
			constexpr explicit RectBasePerlinSolitary(const ::dtl::base::MatrixRange& matrix_range_) noexcept
				:RectBase_t(matrix_range_) {}
			constexpr RectBasePerlinSolitary(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_) {}

			constexpr explicit RectBasePerlinSolitary(const double truncated_proportion_) noexcept
				:truncated_proportion(truncated_proportion_) {}
			constexpr explicit RectBasePerlinSolitary(const double truncated_proportion_, const double mountain_proportion_) noexcept
				:truncated_proportion(truncated_proportion_), mountain_proportion(mountain_proportion_) {}
			constexpr explicit RectBasePerlinSolitary(const double truncated_proportion_, const double mountain_proportion_, const double frequency_) noexcept
				:truncated_proportion(truncated_proportion_), mountain_proportion(mountain_proportion_), frequency(frequency_) {}
			constexpr RectBasePerlinSolitary(const double truncated_proportion_, const double mountain_proportion_, const double frequency_, const Index_Size octaves_) noexcept
			...
			constexpr RectBasePerlinSolitary(const ::dtl::base::MatrixRange& matrix_range_, const double truncated_proportion_) noexcept
				:RectBase_t(matrix_range_),
				truncated_proportion(truncated_proportion_) {}
			constexpr RectBasePerlinSolitary(const ::dtl::base::MatrixRange& matrix_range_, const double truncated_proportion_, const double mountain_proportion_) noexcept
				:RectBase_t(matrix_range_),
				truncated_proportion(truncated_proportion_), mountain_proportion(mountain_proportion_) {}
			constexpr RectBasePerlinSolitary(const ::dtl::base::MatrixRange& matrix_range_, const double truncated_proportion_, const double mountain_proportion_, const double frequency_) noexcept
				:RectBase_t(matrix_range_),
				truncated_proportion(truncated_proportion_), mountain_proportion(mountain_proportion_), frequency(frequency_) {}
			constexpr RectBasePerlinSolitary(const ::dtl::base::MatrixRange& matrix_range_, const double truncated_proportion_, const double mountain_proportion_, const double frequency_, const Index_Size octaves_) noexcept
				:RectBase_t(matrix_range_),
				truncated_proportion(truncated_proportion_), mountain_proportion(mountain_proportion_), frequency(frequency_), octaves(octaves_) {}
			...
			constexpr RectBasePerlinSolitary(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_, const double truncated_proportion_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_),
				truncated_proportion(truncated_proportion_) {}
			constexpr RectBasePerlinSolitary(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_, const double truncated_proportion_, const double mountain_proportion_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_),
				truncated_proportion(truncated_proportion_), mountain_proportion(mountain_proportion_) {}
			constexpr RectBasePerlinSolitary(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_, const double truncated_proportion_, const double mountain_proportion_, const double frequency_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_),
				truncated_proportion(truncated_proportion_), mountain_proportion(mountain_proportion_), frequency(frequency_) {}
			constexpr RectBasePerlinSolitary(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_, const double truncated_proportion_, const double mountain_proportion_, const double frequency_, const Index_Size octaves_) noexcept
				:RectBase_t(start_x_, start_y_, width_, height_),
				truncated_proportion(truncated_proportion_), mountain_proportion(mountain_proportion_), frequency(frequency_), octaves(octaves_) {}
