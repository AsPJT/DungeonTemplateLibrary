...
namespace dtl {
	inline namespace range { //"dtl::range"名前空間に属する
		...
		protected:
			...
			::dtl::base::ShogiList<Matrix_Int_> shogiList{};
		...
		public:
			...
			DTL_VERSIONING_CPP17_NODISCARD
			constexpr ::dtl::base::ShogiList<Matrix_Int_> getValue() const noexcept {
...
#######################################################################################*/
			DTL_VERSIONING_CPP14_CONSTEXPR
				...
				const ::dtl::base::ShogiList<Matrix_Int_> new_draw_value{};
			...
			DTL_VERSIONING_CPP14_CONSTEXPR
				Derived_& setValue(const ::dtl::base::ShogiList<Matrix_Int_>& draw_value_) noexcept {
