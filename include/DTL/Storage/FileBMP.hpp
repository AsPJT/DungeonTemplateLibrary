...
#######################################################################################*/
		...
		class FileBMP : public ::dtl::storage::FileBaseBin<FileBMP<Matrix_Var_, UniquePtr_>, Matrix_Var_, UniquePtr_> {


			///// エイリアス (Alias) /////

			using FileBase_t = ::dtl::storage::FileBaseBin<FileBMP, Matrix_Var_, UniquePtr_>;
