	...
	inline namespace utility { //"dtl::utility"名前空間に属する
		...
		private:
			...
			DTL_VERSIONING_CPP14_CONSTEXPR
				...
				switch (DTL_RANDOM_ENGINE.getBit2()) {
...
#######################################################################################*/
			...
			constexpr CellularAutomation(const Index_Size start_x_, const Index_Size start_y_, const Index_Size width_, const Index_Size height_) noexcept
