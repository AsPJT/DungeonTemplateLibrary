	...
	inline namespace shape {
		...
		private:
			...
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				this->substitutionSTL(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), map_size_, [](const Matrix_Int_ & value_) {return value_ / 2; });
			}
			template<typename Matrix_>
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				inline void substitutionArray(Matrix_ && matrix_, const Index_Size map_size_, const Index_Size max_x_) const noexcept {
				this->substitutionArray(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), max_x_, map_size_, [](const Matrix_Int_ & value_) {return value_ / 2; });
			}
			template<typename Matrix_>
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				inline void substitutionLayer(Matrix_ && matrix_, const Index_Size layer_, const Index_Size map_size_) const noexcept {
				this->substitutionLayer(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), layer_, map_size_, [](const Matrix_Int_ & value_) {return value_ / 2; });
			}
			...
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				this->substitutionSTL(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), getMatrixSize((end_y_ > matrix_[0].size()) ? matrix_[0].size() : end_y_), DUNGEON_TEMPLATE_LIBRARY_FORWARD<Args_>(args_)...);
				return true;
			}
			template<typename Matrix_, typename ...Args_>
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				if (this->altitude < 2) return false;
				this->substitutionSTL(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), getMatrixSize((end_y_ > (std::min)(matrix_[0].size(), end_x_)) ? (std::min)(matrix_[0].size(), end_x_) : end_y_), DUNGEON_TEMPLATE_LIBRARY_FORWARD<Args_>(args_)...);
				return true;
			}
			...
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				if (this->altitude < 2) return false;
				this->substitutionLayer(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), layer_, getMatrixSize((end_y_ > matrix_[0].size()) ? matrix_[0].size() : end_y_), DUNGEON_TEMPLATE_LIBRARY_FORWARD<Args_>(args_)...);
				return true;
			}
			template<typename Matrix_, typename ...Args_>
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				if (this->altitude < 2) return false;
				this->substitutionLayer(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), layer_, getMatrixSize((end_y_ > (std::min)(matrix_[0].size(), end_x_)) ? (std::min)(matrix_[0].size(), end_x_) : end_y_), DUNGEON_TEMPLATE_LIBRARY_FORWARD<Args_>(args_)...);
				return true;
			}
			...
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				if (this->altitude < 2) return false;
				this->substitutionSTL(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), getMatrixSize((end_y_ > end_x_) ? end_x_ : end_y_), DUNGEON_TEMPLATE_LIBRARY_FORWARD<Args_>(args_)...);
				return true;
			}
			...
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				if (this->altitude < 2) return false;
				this->substitutionLayer(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), layer_, getMatrixSize((end_y_ > end_x_) ? end_x_ : end_y_), DUNGEON_TEMPLATE_LIBRARY_FORWARD<Args_>(args_)...);
				return true;
			}
			...
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				if (this->altitude < 2) return false;
				this->substitutionArray(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), getMatrixSize((end_y_ > end_x_) ? end_x_ : end_y_), max_x_, DUNGEON_TEMPLATE_LIBRARY_FORWARD<Args_>(args_)...);
				return true;
			}
		...
		public:
			...
			constexpr bool draw(Matrix_ && matrix_) const noexcept {
				return (this->width == 0) ? this->drawSTL(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), (this->height == 0 || this->start_y + this->height >= matrix_.size()) ? matrix_.size() : this->start_y + this->height) : this->drawWidthSTL(matrix_, this->start_x + this->width, (this->height == 0 || this->start_y + this->height >= matrix_.size()) ? matrix_.size() : this->start_y + this->height);
			}
			template<typename Matrix_, typename Function_>
			constexpr bool drawOperator(Matrix_ && matrix_, Function_ && function_) const noexcept {
				return (this->width == 0) ? this->drawSTL(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), (this->height == 0 || this->start_y + this->height >= matrix_.size()) ? matrix_.size() : this->start_y + this->height, function_) : this->drawWidthSTL(matrix_, this->start_x + this->width, (this->height == 0 || this->start_y + this->height >= matrix_.size()) ? matrix_.size() : this->start_y + this->height, function_);
			}

			//LayerSTL
			template<typename Matrix_>
			constexpr bool draw(Matrix_ && matrix_, const Index_Size layer_) const noexcept {
				return (this->width == 0) ? this->drawLayerSTL(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), layer_, (this->height == 0 || this->start_y + this->height >= matrix_.size()) ? matrix_.size() : this->start_y + this->height) : this->drawLayerWidthSTL(matrix_, layer_, this->start_x + this->width, (this->height == 0 || this->start_y + this->height >= matrix_.size()) ? matrix_.size() : this->start_y + this->height);
			}
			template<typename Matrix_, typename Function_>
			constexpr bool drawOperator(Matrix_ && matrix_, const Index_Size layer_, Function_ && function_) const noexcept {
				return (this->width == 0) ? this->drawLayerSTL(DUNGEON_TEMPLATE_LIBRARY_FORWARD<Matrix_>(matrix_), layer_, (this->height == 0 || this->start_y + this->height >= matrix_.size()) ? matrix_.size() : this->start_y + this->height, function_) : this->drawLayerWidthSTL(matrix_, layer_, this->start_x + this->width, (this->height == 0 || this->start_y + this->height >= matrix_.size()) ? matrix_.size() : this->start_y + this->height, function_);
			}
