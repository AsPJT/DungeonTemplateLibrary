	...
	inline namespace shape {
		...
		private:
			...
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				matrix_[end_y_][end_x_] = ((dtl::random::mt32bit.probability()) ? this->draw_value.front() : this->draw_value[dtl::random::mt32bit.get<std::size_t>(draw_value.size())]);
			}
			template<typename Matrix_>
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				matrix_[end_y_ * max_x_ + end_x_] = ((dtl::random::mt32bit.probability()) ? this->draw_value.front() : this->draw_value[dtl::random::mt32bit.get<std::size_t>(draw_value.size())]);
			}
			template<typename Matrix_>
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				matrix_[end_y_][end_x_][layer_] = ((dtl::random::mt32bit.probability()) ? this->draw_value.front() : this->draw_value[dtl::random::mt32bit.get<std::size_t>(draw_value.size())]);
			}
			template<typename Matrix_Value_>
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				inline void substitutionList(Matrix_Value_&& matrix_) const noexcept {
				matrix_ = ((dtl::random::mt32bit.probability()) ? this->draw_value.front() : this->draw_value[dtl::random::mt32bit.get<std::size_t>(draw_value.size())]);
			}
			...
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				if (function_(matrix_[end_y_][end_x_])) matrix_[end_y_][end_x_] = ((dtl::random::mt32bit.probability()) ? this->draw_value.front() : this->draw_value[dtl::random::mt32bit.get<std::size_t>(draw_value.size())]);
			}
			template<typename Matrix_, typename Function_>
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				if (function_(matrix_[end_y_ * max_x_ + end_x_])) matrix_[end_y_ * max_x_ + end_x_] = ((dtl::random::mt32bit.probability()) ? this->draw_value.front() : this->draw_value[dtl::random::mt32bit.get<std::size_t>(draw_value.size())]);
			}
			template<typename Matrix_, typename Function_>
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				if (function_(matrix_[end_y_][end_x_][layer_])) matrix_[end_y_][end_x_][layer_] = ((dtl::random::mt32bit.probability()) ? this->draw_value.front() : this->draw_value[dtl::random::mt32bit.get<std::size_t>(draw_value.size())]);
			}
			...
			DUNGEON_TEMPLATE_LIBRARY_CPP14_CONSTEXPR
				...
				if (function_(matrix_)) matrix_ = ((dtl::random::mt32bit.probability()) ? this->draw_value.front() : this->draw_value[dtl::random::mt32bit.get<std::size_t>(draw_value.size())]);
			}
